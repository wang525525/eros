            ...
            <div className="col-sm-12 col-md-8 col-lg-6 pt-5">
              <div className="background-gray">
                ...
                <Tabs bottom={true}>
                  ...
                  >
                    <div className="client-home-panel fs-n">
                      ...
                      <div className="row justify-content-center pt-3 fs-n">
                ...
                <div className="d-flex p-2 background-text3">
                  ...
                  <div className="ml-auto my-auto">
                    <button className="btn btn-primary px-3 py-2" onClick={gotoContact}>CONSTRATAR</button>
                  </div>
