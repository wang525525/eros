...
function App() {
  ...
  const url_continue        =   Config.ConfigAppUrl+"Auth/EscortRegister7";
  ...
  function handleUpload(e){
    ...
    Functions.PostAsync("User","uploadPhotoEscort",{renameFile:renameFile,token:user.token,userfile:e.target.files[0],type:e.target.attributes['doc'].value},context,{name:"callbackChangeImage",funct:callbackChangeImage})
    e.preventDefault();
  }
  ...
  function set_photos(v){
    switch (v[0]) {
      case "photo_0":
        setPhoto_0(base_url+v[1])
      break;
      case "photo_1":
        setPhoto_1(base_url+v[1])
      break;
      case "photo_2":
        setPhoto_2(base_url+v[1])
      break;
      case "photo_3":
        setPhoto_3(base_url+v[1])
      break;
      case "photo_4":
        setPhoto_4(base_url+v[1])
      break;
      case "photo_5":
        setPhoto_5(base_url+v[1])
      break;
      case "photo_6":
        setPhoto_6(base_url+v[1])
      break;
    }
  }
