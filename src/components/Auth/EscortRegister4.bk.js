        ...
        <div className="container">
            ...
            <div className="col">
              <div  className="scrolling">
                <div className="scrolling-item">
                  <div className="btn btn-secondary btn-sq-video text-white p-0">
          ...
          <div className="row justify-content-md-center mt-0">
            <div className="col col-sm-6">
              <Link className="btn btn-primary btn-block text-white text-decoration-none" href={Config.ConfigAppUrl+"Auth/EscortRegister5"} >
                Continuar
              </Link>
            </div>
          </div>
