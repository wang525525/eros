        ...
        <div className="container">
          <div className="row justify-content-center mt-4 ">
            <div className="col-12 col-sm-4 text-center ">
              <div className="App-Question  text-left">Sobre el servicio</div>
            </div>
          </div>

          <div className="row justify-content-center ">
            <div className="col-12 col-sm-4 mt-3 border-bottom border-top background-gray">
              <PerfilHome
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-sm-4  border-bottom background-gray">
              <PerfilHome
                question={[
                            {
                ...
                label="Escoge el tiempo de servicio"
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-sm-4  border-bottom background-gray">
              <PerfilHome
                ...
                label="Selecciona el lugar del encuentro"
                name="amanecidaid"
                placeholder="0.00"
                htmlLabel="30 Minutos"
                times={
