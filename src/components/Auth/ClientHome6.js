          ...
          <div className="row justify-content-center set_width_container">
            <div className="col-sm-6">
              ...
              <div className="row justify-content-center mt-4 ">
                <div className="col-11 col-sm-8  background-gray rounded">
                  <div className="text-gray text-left   p-2  ">
                    El prestador de servicio tendrá un limite de <div className="text-fucsia">10 minutos</div>
                    para aceptar o rechazar tu solicitud.
                    <div>
                      Te notificaremos su respuesta
                    </div>
              ...
              <div className="row justify-content-center mt-4 ">
                <div className="col-11 col-sm-8  ">
                  <div className=" text-center p-2 text-gray h4 ">
                    10:00
                  </div>
                </div>
              </div>
