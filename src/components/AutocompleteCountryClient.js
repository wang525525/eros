          ...
          <div className="col-12 col-sm-4 text-center">
            <div className="input-group mb-3">
              ...
              <div className="p-0 m-0 position-relative">
                  <input autocomplete="off" name="nationality" className="form-control" placeholder="Nacionalidad" id="query" type="text" onChange={this.onTextChange} value={this.state.text}/>
